...
// EFFECTS: outputs that the bot is logged in and pins the instruction message to the general channel
function onReady(){
...
// EFFECTS: handles calls to !pin, !clean, and does nothing otherwise
...
// EFFECTS: sends a message with desired content and pins it, deleting the user's !pin call
...
// EFFECTS: if user confirms they want to clean the channel, i messages are deleted as well as the last "!clean" call
...
// EFFECTS: replaces the user's nickname with desired name
//          if the user is not the owner/higher in hierarchy
...
// EFFECTS: Creates a temporary invite when reacted with '😄', and a permanent invite with '🤩'
        ...
        .then(function() {
            ...
            .then(collected => {
                ...
                .then(msg => {
                    ...
                    msg.awaitReactions(filter, { max: 1, time: 30000, errors: ['time'] })
                        .then(collected => {
                            roleEmoji = collected.first()
                            // TODO 1: debug the role creation
                            // TODO 2: add new role to emojis.json
                            //         via roleEmoji: new role fetched id
                            // TODO 3: edit other roles to use emojis.json instead
